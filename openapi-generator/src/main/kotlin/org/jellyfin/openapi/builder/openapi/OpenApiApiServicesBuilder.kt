...
class OpenApiApiServicesBuilder(
	...
	private fun buildRequestBody(
		...
		return when (requestBodyType) {
			...
			// Form data (url encodeD) model body
			MimeType.APPLICATION_X_WWW_FORM_URLENCODED -> ApiServiceOperationRequestBody.FormData(model, false)
			// Form data model body
			MimeType.MULTIPART_FORM_DATA -> ApiServiceOperationRequestBody.FormData(model, true)
			// Image body
