...
sealed interface ApiServiceOperationRequestBody {
	...
	data class Json(override val type: TypeName) : ApiServiceOperationRequestBody

	data class FormData(override val type: TypeName, val multipart: Boolean) : ApiServiceOperationRequestBody
